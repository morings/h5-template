<template>
  <x-input   ref="elInput" :value="num" :disabled="disabled"  :max="digit==0?9:16"    @on-blur="blur" :placeholder="placeholder" :readonly='readonly' :is-type='isType' :required='required' :title='title' :type="digit?'number':'tel'" :text-align='textAlign' ></x-input>
</template>
<script>
export default {
  name:'NumInput',
